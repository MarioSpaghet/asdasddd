if SERVER then
    ...
    -- Map Analysis ConVars
    CreateConVar("webswing_ma_samples", "220", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Max map analysis sample points (100-600)", 100, 600)
    CreateConVar("webswing_ma_flat_thresh", "0.95", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Normal.z threshold for flat terrain (0.85-0.99)", 0.85, 0.99)
    CreateConVar("webswing_ma_sloped_thresh", "0.7", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Normal.z threshold for sloped terrain (0.5-0.9)", 0.5, 0.9)
    CreateConVar("webswing_ma_open_dir_step_deg", "22.5", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Direction step degrees for open-space sweeps (10-45)", 10, 45)
    CreateConVar("webswing_ma_corridor_radius", "200", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Corridor openness check radius (100-400)", 100, 400)
    CreateConVar("webswing_ma_ceiling_clearance", "96", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Required clearance below ceiling for crawl (64-144)", 64, 144)
    CreateConVar("webswing_ma_landmark_min", "600", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Minimum landmark radius in units (400-1200)", 400, 1200)
    CreateConVar("webswing_ma_debug", "0", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Enable verbose map analysis debug prints", 0, 1)
    CreateConVar("webswing_map_wind_influence", "0.2", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Wind influence on range/speed (0-0.5)", 0, 0.5)
    CreateConVar("webswing_map_indoor_influence", "0.2", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Indoor lighting influence on range/vertical boost (0-0.5)", 0, 0.5)
    CreateConVar("webswing_ma_smooth_params", "0.4", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Parameter smoothing factor 0..1 (higher = smoother)", 0, 1)
